...
Applying all past concepts was very neat, it blew my mind when KCD did his own interpretation of PropTypes
and know I can understand how prop types abstractation validate any prop recevied by the component. 

Another thing that interest me, it was that while it was said that you need previous experience with javascript,
statments and expressions where a thing that I was not familiar as a concept. Like imperative vs declarative programming, 
this is something that you just 'know' how it works, but you don't know how to explain it.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=carlosreynaet%40gmail.com).
